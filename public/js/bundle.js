...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibXN0Z2giLCJhIjoiY2syOGk0MWZxMXhkdzNubXFobjRxNGRibiJ9.BnUuw7_HtunZuQtsfdOqpg';
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // 2) Add marker to the map

    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // 3) Add popup the the marker  
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type, " successfully updated"));
              window.setTimeout(function () {
                location.reload(true);
              }, 1500);
            }
...
var stripe = Stripe('pk_test_jdZkX9BW18QxDSyBFrQZXiog00EOaxP6G5');
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              form.append('photo', document.querySelector('#photo').files[0]); // console.log('form :', ...form);
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var tourId = bookBtn.dataset.tourId; // const price = bookBtn.dataset.price;
